...
ALTER TYPE public.account_type OWNER TO cse340jkc;
-- Table structure for table 'classifcation'
CREATE TABLE public.classification (
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name CHARACTER VARYING NOT NULL,
    CONSTRAINT classification_pk PRIMARY KEY (classification_id)
);
--Create table for favorite list
CREATE TABLE public.test(
    fav_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    fav_list integer [],
    FOREIGN KEY (fav_id) REFERENCES account(account_id) -- Table Structure for table 'inventory'
